...
export const getLockedSpliceMarkers = () => getAudioStoreState().lockedSpliceMarkers;

export const getSpliceMarkers = () => getAudioStoreState().spliceMarkers;

export const getIsProcessingAudio = () => getAudioStoreState().isProcessingAudio;
...
export const getStoreValues = <T extends keyof ReturnType<typeof getAudioStoreState>>(
  ...keys: T[]
