...
export const audioBufferToWavFormat = (buffer: AudioBuffer, format: ExportFormat, spliceMarkersStore: number[]): ArrayBuffer => {
...
// Export handlers
export const downloadWav = (arrayBuffer: ArrayBuffer, filename: string = 'morphedit-export.wav') => {
